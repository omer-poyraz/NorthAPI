...
namespace NorthAPI.Migrations
{
    ...
    [Migration("20240415120213_AppInfo")]
            ...
            modelBuilder.Entity("Entities.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 15, 12, 2, 12, 621, DateTimeKind.Utc).AddTicks(268),
                            UserId = 1
                        },
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 15, 12, 2, 12, 621, DateTimeKind.Utc).AddTicks(272),
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            NotificationId = 1,
                            CreateAt = new DateTime(2024, 4, 15, 12, 2, 12, 626, DateTimeKind.Utc).AddTicks(943),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "4ec275ab-ff1e-4fbc-9bd1-1e0612412582",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "98699155-caf0-4deb-9007-151772898c1a",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
