...
namespace NorthAPI.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "CategoryImg", "CategoryName" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "Price", "ProductDesc", "ProductName", "ProductStar" },
                values: new object[,]
                {
                    { 1, 1, 250m, "Yeni sezon pamuk tshirt.", "Tshirt", 4 },
                    { 2, 2, 530m, "Soğuk geçirmez kalın kazak.", "Mavi Kazak", 5 }
                });
